...
git config --global user.name "AmeyaPatil1"
git config --global user.email "ameyapatil723@gmail.com"

REM Clone github repository
git clone "https://github.com/AmeyaPatil1/Iris-Deployment1.git" "repository"
